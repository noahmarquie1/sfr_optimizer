...
# Install packages from requirements.txt with additional error handling
COPY requirements.txt /tmp/requirements.txt
RUN /openmc_venv/bin/pip install --no-cache-dir -r /tmp/requirements.txt
